...
class Config(metaclass=Singleton):
    ...
    # The path to the stdout and stderr logs of tunnelvision-server.
    log_stdout: str = os.path.join(os.path.expanduser("~"), ".cache", "tunnelvision", "server.out")
    log_stderr: str = os.path.join(os.path.expanduser("~"), ".cache", "tunnelvision", "server.err")
    ...
    def __post_init__(self):
        ...
        if os.path.exists(self.log_stderr):
            os.remove(self.log_stderr)
